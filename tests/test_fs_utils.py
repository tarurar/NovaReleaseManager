...
def test_search_files_with_ext(create_test_files_ext):
    ...
    assert set(
        fs.search_files_with_ext(root_dir, '.txt')) == set(
...
def test_search_files_with_content(create_test_files_content):
    ...
    assert set(fs.search_files_with_content(file_paths, 'example')
               ) == set([os.path.join(root_dir, 'test_file_2.txt')])
    assert set(
        fs.search_files_with_content(file_paths, 'test')) == set(
